...
import com.dicoding.bfaa_submission3.adapter.FollowingFavoritAdapter
import com.dicoding.bfaa_submission3.model.User
import com.loopj.android.http.AsyncHttpClient
import com.loopj.android.http.AsyncHttpResponseHandler
import cz.msebera.android.httpclient.Header
import kotlinx.android.synthetic.main.fragment_following_favorit.*
...
class FollowingFavoritFragment : Fragment() {
    ...
    companion object {
        ...
        private val TAG = FollowingFavoritFragment::class.java.simpleName
    }
    ...
    override fun onCreateView(
        ...
        val username2 = arguments?.getString(FollowingFavoritFragment.ARG_USERNAME)
    ...
    fun newInstance(username: String?): FollowingFavoritFragment {
        ...
        val bundle = Bundle()
        bundle.putString(FollowingFavoritFragment.ARG_USERNAME, username)
    ...
    fun getFollowing(username1: String?) {
        ...
        client.get(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(
                ...
                try {
                    ...
                    if (response.length() != 0) {
                        ...
                        Log.d(FollowingFavoritFragment.TAG, list2.toString())
                        if (list2.size != 0) {
                            showListUser()
                        }
            ...
            override fun onFailure(
                ...
                Log.d(FollowingFavoritFragment.TAG, "ADA YANG SALAH")
            }
    ...
    private fun showListUser() {
        ...
        val listUserAdapter = FollowingFavoritAdapter(list2)
